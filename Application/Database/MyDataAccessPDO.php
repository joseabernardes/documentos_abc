...
class MyDataAccessPDO extends MyDataAcessPDOBase {
     ...
     */
    public function __construct($host = Conf::SGBD_HOST_NAME, $databaseName = Conf::SGBD_DATABASE_NAME, $userName = Conf::SGBD_USERNAME, $password = Conf::SGBD_PASSWORD) {
     ...
     */
    protected function getRecords($table, Array $where = null, Array $order = null) {

        try {
            $sql = MyDataAccessPDOSQLFactory::buildSQL(self::SELECT_OPERATION, $table, $where, $order);
    ...
    protected function delete($table, Array $where = null) {
        $sql = MyDataAccessPDOSQLFactory::buildSQL(self::DELETE_OPERATION, $table, $where);
        try {
